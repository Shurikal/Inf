package kap10Vererbung.netzwerk1;

import java.util.ArrayList;

/**
 * Diese Klasse speichert Informationen über eine kap10Vererbung.netzwerk2.Einsendung innerhalb eines sozialen
 * Netzwerks. Der Hauptteil der kap10Vererbung.netzwerk2.Einsendung besteht aus einer (möglicherweise
...
public class NachrichtenEinsendung 
{
    ...
    /**
     * Füge der kap10Vererbung.netzwerk2.Einsendung einen Kommentar hinzu.
     * 
    ...
    /**
     * Liefere den Text dieser kap10Vererbung.netzwerk2.Einsendung.
     * 
     * @return  den Text der kap10Vererbung.netzwerk2.Einsendung
     */
    ...
    /**
     * Liefere die Zeit, zu der die kap10Vererbung.netzwerk2.Einsendung erstellt wurde.
     * 
     * @return  die Zeit, zu der die kap10Vererbung.netzwerk2.Einsendung erstellt wurde (als Systemzeit-Wert)
     */
    ...
    /**
     * Zeige die Details der kap10Vererbung.netzwerk2.Einsendung an.
     * 
